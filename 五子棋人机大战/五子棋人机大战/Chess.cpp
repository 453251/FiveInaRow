...
bool Chess::checkOver()
{
	if (checkWin())
	{
		Sleep(1500);
		if (playerFlag == false) 
		{  //黑棋赢（玩家赢）,此时标记已经反转，轮到白棋落子
			mciSendString("play ..\\image\\胜利.mp3", 0, 0, 0);
			loadimage(0, "..\\image\\胜利.jpg");
		}
		else 
		{
			mciSendString("play ..\\image\\失败.mp3", 0, 0, 0);
			loadimage(0, "..\\image\\失败.jpg");
		}
